    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm rounded-full px-2 py-1 flex items-center space-x-1">
          ...
          <span className="text-xs text-gray-700">{city?.popularity_score || 'N/A'}</span>
        </div>
        ...
        <div className="absolute bottom-3 left-3 right-3">
          <h3 className="text-white text-lg font-medium">{city?.name || 'Unknown City'}</h3>
        </div>
      </div>

      {/* Content */}
      <div className="p-4">
        <p className="text-gray-600 text-sm mb-3 line-clamp-2">{city?.short_tagline || 'Explore this beautiful destination.'}</p>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="text-sm text-gray-600">{city?.safety_score || 'N/A'}/10</span>
            </div>
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="text-sm text-gray-600">
                {city?.best_time_to_visit?.split(' ')[0] || 'Anytime'}
              </span>
            </div>
          </div>
