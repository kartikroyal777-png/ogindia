  ...
  const renderStepContent = () => {
    switch (step) {
      case 1: // Days
        return (
          <>
            <h2 className="text-2xl font-medium text-gray-900 mb-4 text-center">How many days are you planning?</h2>
      ...
      case 2: // Destination
        return (
          <>
            <h2 className="text-2xl font-medium text-gray-900 mb-4 text-center">Where do you want to go?</h2>
      ...
      case 3: // Style
        return (
          <>
            <h2 className="text-2xl font-medium text-gray-900 mb-6 text-center">What's your travel style?</h2>
      ...
      case 4: // Companions
        return (
          <>
            <h2 className="text-2xl font-medium text-gray-900 mb-6 text-center">Who are you traveling with?</h2>
            <div className="grid grid-cols-2 gap-4">
